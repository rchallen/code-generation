...
public enum HandledDatatypes {
	...
	URI(XSDVocabulary.ANY_URI.getIRI(), "java.net.URI", "java.net.URI") {
	...
	DATE_TIME(XSDVocabulary.DATE_TIME.getIRI(), "javax.xml.datatype.XMLGregorianCalendar", "javax.xml.datatype.XMLGregorianCalendar") {
